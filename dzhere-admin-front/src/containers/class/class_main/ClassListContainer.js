...
import ClassListComponent from "../../../components/class/class_main/ClassListComponent";
import { useIsFocused, useNavigation } from "@react-navigation/core";
import { getAdmin, getClassList } from "../../../lib/api/class/course";
import { getClass, setAgency } from "../../../modules/class/course";
...
const ClassListContainer = () => {
  ...
  async function adminInfoApi() {
    ...
    const data = await getAdmin({ u_phone: userInfo.userPhone });
    // console.log(data);
    setAgencyInfo(data);
  ...
  async function classListApi() {
    ...
    const data = await getClassList({ u_phone: userInfo.userPhone });
    // console.log(data);
    setClassList(data);
