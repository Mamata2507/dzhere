...
const [LOAD_AGENCY_LIST, LOAD_AGENCY_LIST_SUCCESS, LOAD_AGENCY_LIST_FAILURE] =
  createRequestActionTypes("teacher/LOAD_AGENCY_LIST");
const [LOAD_LESSON_LIST, LOAD_LESSON_LIST_SUCCESS, LOAD_LESSON_LIST_FAILURE] =
  createRequestActionTypes("teacher/LOAD_LESSON_LIST");
const [SEARCH_ATTEND, SEARCH_ATTEND_SUCCESS, SEARCH_ATTEND_FAILURE] =
  createRequestActionTypes("teacher/SEARCH_ATTEND");
const [UPDATE_ATTEND, UPDATE_ATTEND_SUCCESS, UPDATE_ATTEND_FAILURE] =
  createRequestActionTypes("teacher/UPDATE_ATTEND");

const SET_CHECK = "student/SET_CHECK";
const SET_VALUE = "student/SET_VALUE";
const RESET_LIST = "teacher/RESET_LIST";
const SET_LATE_STATUS = "teacher/SET_LATE_STATUS";
const SET_ABSCENT_STATUS = "teacher/SET_ABSCENT_STATUS";
const SET_LEAVE_STATUS = "teacher/SET_LEAVE_STATUS";
const SET_NOT_EXIT_STATUS = "teacher/SET_NOT_EXIT_STATUS";
