...
public class Agency {
    ...
    @Builder
	public Agency(int u_idx, String u_phone, String u_pw, String u_email, int u_alarm, String u_name, int u_accept, int u_auth, int c_idx, int ag_idx, String ag_name) {
		this.u_idx = u_idx;
