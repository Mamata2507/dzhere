...
public class Attend {
    ...
    @Builder
    public Attend(int a_idx, Timestamp a_attend_time, Timestamp a_exit_time, int a_leave, int a_late_status, int a_absent, int a_not_exit, Time a_result_time, Timestamp a_today_date, int u_idx) {
        this.a_idx = a_idx;
