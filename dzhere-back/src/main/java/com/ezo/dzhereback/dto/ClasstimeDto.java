...
public class ClasstimeDto {
	...
	@Builder
	public ClasstimeDto(int ct_idx, String ct_day, String ct_start_time, String ct_end_time, String ct_attend_starttime,String ct_attend_endtime, String ct_start_date, String ct_end_date, String ct_break_start, String ct_break_end, String c_name, int ag_idx, int c_idx) {
		this.ct_idx = ct_idx;
		this.ct_day = ct_day;
