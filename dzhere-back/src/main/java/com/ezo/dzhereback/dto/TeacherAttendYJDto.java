...
public class TeacherAttendYJDto {
    ...
    public TeacherAttendYJDto(int a_idx, String a_today_date, String c_name, String u_name, String a_attend_time, String a_exit_time, int a_late_status, int a_leave, int a_absent, int a_not_exit, String a_result_time) {
        this.a_idx = a_idx;
